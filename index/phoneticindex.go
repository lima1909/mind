...
func NewPhoneticIndex[OBJ any](fieldGetFn FromField[OBJ, string]) *PhoneticIndex[OBJ, SingleValueHandler[OBJ, string]] {
...
func NewPhoneticIndexSlice[OBJ any](fieldGetFn FromFieldSlice[OBJ, string]) *PhoneticIndex[OBJ, MultiValueHandler[OBJ, string]] {
	return &PhoneticIndex[OBJ, MultiValueHandler[OBJ, string]]{
		handler:   NewMultiValueHandler(fieldGetFn),
		soundexFn: soundex,
		codes:     make(map[uint32]*lidx.RawIDs32),
	}
}
...
func (pi *PhoneticIndex[OBJ, H]) Equal(value any) (*lidx.RawIDs32, error) {
	return nil, errr.InvalidOperationError{IndexName: PhoneticIndexName, Op: query.OpEq}
}
...
func (pi *PhoneticIndex[OBJ, H]) Match(_ *lidx.RawIDs32, op query.FilterOp, value any) (*lidx.RawIDs32, bool, error) {
	...
	if op.Op != query.OpSounds {
		return nil, false, errr.InvalidOperationError{IndexName: PhoneticIndexName, Op: op.Op}
	}
