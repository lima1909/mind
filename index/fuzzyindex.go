...
func NewFuzzyIndex[OBJ any](fieldGetFn FromField[OBJ, string]) *FuzzyIndex[OBJ] {
...
func (fi *FuzzyIndex[OBJ]) Equal(value any) (*lidx.RawIDs32, error) {
	return nil, errr.InvalidOperationError{IndexName: FuzzyIndexName, Op: query.OpEq}
}

func (fi *FuzzyIndex[OBJ]) Match(_ *lidx.RawIDs32, op query.FilterOp, value any) (*lidx.RawIDs32, bool, error) {
	if op.Op != query.OpFuzzy {
		return nil, false, errr.InvalidOperationError{IndexName: FuzzyIndexName, Op: op.Op}
	}
