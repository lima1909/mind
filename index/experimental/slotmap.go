...
// A SlotMap is a data structure designed to store values with unique and persistent keys.
// It allows for efficient operations such as insertion, access, and removal of elements, all performed in constant time, O(1).
//
// Key Features:
// * Unique Keys
//
//     - Each value inserted into a slotmap is assigned a unique key.
//     - These keys remain valid until the corresponding value is explicitly removed.
//
// * Efficient Operations
//
//     - Insertion: Adds a new value and returns a unique key.
//     - Access: Retrieves a value using its unique key.
//     - Removal: Deletes a value while ensuring the key remains invalidated.
