...
func NewTrigramIndex[OBJ any](fieldGetFn FromField[OBJ, string]) *TrigramIndex[OBJ] {
	return NewTrigramIndexWithCapacity(fieldGetFn, 0)
}

func NewTrigramIndexWithCapacity[OBJ any](fieldGetFn FromField[OBJ, string], size int) *TrigramIndex[OBJ] {
...
func (ti *TrigramIndex[OBJ]) Equal(value any) (*lidx.RawIDs32, error) {
	return nil, errr.InvalidOperationError{IndexName: TrigramIndexName, Op: query.OpEq}
}
...
func (ti *TrigramIndex[OBJ]) Match(allIDs *lidx.RawIDs32, op query.FilterOp, value any) (*lidx.RawIDs32, bool, error) {
	...
	if op.Op != query.OpLike {
		return nil, false, errr.InvalidOperationError{IndexName: TrigramIndexName, Op: op.Op}
	}
