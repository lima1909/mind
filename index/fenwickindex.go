...
func NewFenwickIndex[OBJ any, V Int](fieldGetFn FromField[OBJ, V], maxVal int) *FenwickIndex[OBJ, V] {
...
func NewFenwickIndexWithMinValue[OBJ any, V Int](fieldGetFn FromField[OBJ, V], minVal, maxVal int) *FenwickIndex[OBJ, V] {
	if minVal > maxVal {
...
func (fx *FenwickIndex[OBJ, V]) Equal(value any) (*lidx.RawIDs32, error) {
	return nil, errr.InvalidOperationError{IndexName: FenwickIndexName, Op: query.OpEq}
}
...
func (fx *FenwickIndex[OBJ, V]) Match(allIDs *lidx.RawIDs32, op query.FilterOp, value any) (*lidx.RawIDs32, bool, error) {
	...
	default:
		return nil, false, errr.InvalidOperationError{IndexName: FenwickIndexName, Op: op.Op}
	}
}
